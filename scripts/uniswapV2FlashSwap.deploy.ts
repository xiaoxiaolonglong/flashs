...
async function main() {
	const UniswapV2FlashSwap = await ethers.getContractFactory("UniswapV2FlashSwapPath");
	...
	await uni.flashSwap([usdcAddress, "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2"], parseUnits("1000", 6));
}
